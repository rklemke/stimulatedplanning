...
public class CourseDescriptor extends GenericDescriptor {
	...
	public static CourseDescriptor generateTestCourse() {
		...
		for (int i=1; i<6; i++) {
			ModuleDescriptor module = new ModuleDescriptor("c01.m0"+i, "Module 1."+i, "Module 1."+i+" Description", "");
			course.addModule(module);
			for (int j=1; j<6; j++) {
				LessonDescriptor lesson = new LessonDescriptor("c01.m0"+i+".l0"+j,"Lesson 1."+i+"."+j,"Lesson 1."+i+"."+j+" Description","");
				module.addLesson(lesson);
			}
		}
	
		GoalDescriptor goal1 = new GoalDescriptor("c01.g01", "Browsing the Course", "Browsing the Course Description", "");
		...
		GoalDescriptor goal2 = new GoalDescriptor("c01.g02", "Internet Security", "Internet Security Description", "");
		...
		GoalDescriptor goal3 = new GoalDescriptor("c01.g03", "Computer Security", "Computer Security Description", "");
		...
		GoalDescriptor goal4 = new GoalDescriptor("c01.g04", "Safe behaviour on the Internet", "Safe behaviour on the Internet Description", "");
		...
		GoalDescriptor goal5 = new GoalDescriptor("c01.g05", "Complete the Course", "I intend to complete the course Description", "");
